...
void display( void )
{
  ...
  // start transforming the shoulder, elbow, and hand objects
  glPushMatrix();
  {
    // translate the rotation axis to the z-axis
    glTranslated( 0.0, 0.0, 0.0 );
    // rotate the shoulder, elbow, and hand objects
    ...
    //start transforming the elbow and hand objects
    glPushMatrix();	
    {
      // translate the rotation axis to the z-axis
      glTranslated( 1.2, 0.0, 0.0 );
      // rotate the elbow and hand objects
      glRotated( (double)elbow, 0.0, 0.0, 1.0 );
      // draw the rotation axis of the elbow object in yellow
      // set color to yellow
      ...
      // draw the elbow object
      // start transforminb the elbow cube
      glPushMatrix();
      // scale the elbow cube    
      glScaled( 0.8, 0.2, 0.5 );
      // draw an elbow cube
      draw_object();
      // finish transforming the elbow cube
      glPopMatrix();
	

      // start transforming the hand object only
      glPushMatrix();	
      {
	// translate the rotation axis to the z-axis
	glTranslated( 0.8, 0.0, 0.0 );
	// rotate the hand object
	...
	// draw the hand object
	// start transforming the hand cube
	glPushMatrix();
	// scale the hand cube    
	glScaled( 0.4, 0.2, 0.4 );
	// draw an hand cube
	draw_object();
	// finish transforming the hand cube
	glPopMatrix();
      }
  ...
  // finish transforming the hand object
  glPopMatrix();
