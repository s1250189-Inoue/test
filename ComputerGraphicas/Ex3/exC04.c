...
void display( void )
{
    ...
    // start transforming the shoulder and elbow objects
    glPushMatrix();
    {
	// translate the rotation axis to the z-axis
	glTranslated( -1.0, 0.0, 0.0 );
        // rotate the shoulder and elbow objects
	...
	glPopMatrix();
            ...
            // start transforming the elbow object only
	glPushMatrix();	
	{
	    // translate the rotation axis to the z-axis
	    glTranslated( 1.0, 0.0, 0.0 );
	    // rotate the elbow object
        ...
        // finish transforming the elbow object
	glPopMatrix();
